 ...
 * @param {*} onError 
 */
function callAsync(resultBack, callback, onError) {
...
class MyPromise {
    ...
    _resolve(val) {
        ...
        console.log('传递参数：' + JSON.stringify(val));
        console.log(this._fulfilledQueue);
